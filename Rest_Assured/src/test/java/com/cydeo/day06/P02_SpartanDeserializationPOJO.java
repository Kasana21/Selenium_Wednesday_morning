...
public class P02_SpartanDeserializationPOJO extends SpartanTestBase {
    ...
    public void test3() {
        ...
        System.out.println("search.getContent() = " + search.getContent().get(1));

        System.out.println("search.getContent() = " + search.getContent().get(1).getName());
    ...
    public void test4() {
        ...
        JsonPath jsonPath = response.jsonPath();
        List<Spartan> allListSpartan = jsonPath.getList("content", Spartan.class);

        for (Spartan spartan : allListSpartan) {
            System.out.println("spartan = " + spartan);
        }

        System.out.println("allListSpartan.get(1).getId() = " + allListSpartan.get(1).getId());
