...
public class ArrayElements {
    public static void main(String[] args) {
        /* ArrayElements Task: Create a class named ArrayElements and write a program with the following specifications:
...
//1.2 Assign values from 1 to 100 to the indexes of the array.
        for (int i = 1; i <= 100 ; i++) {
            nums[i - 1] = i;//nums [i -1]-> made to proper way of storing to correct index
        }
// 1.3 Display the array elements in a single line separated by spaces.
