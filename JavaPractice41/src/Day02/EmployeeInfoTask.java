package Day02;
/*
EmployeeInfo Task: Create a class named EmployeeInfo and write a program with the following requirements:
...
public class EmployeeInfoTask {
    public static void main(String[] args) {
        ...
        System.out.println("Salary: $"+ salary);// "Salary: "+"$" + salary
