...
public class BankOfAmerica {
    public static void main(String[] args) {
        ...
        Tester tester1 = new Tester("Josh", 'M', LocalDate.of(1985, 4, 5) , "A01", "QA", 1000000);
        System.out.println(tester1);//Tester{name='Josh', gender=M, DOB=1985-04-05, age=37, employeeId='A01', jobTitle='QA', salary=1000000.0}
