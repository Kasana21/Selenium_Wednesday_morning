...
public class TC04_StaleElementReferenceException {
    public static void main(String[] args) {
      ...
      //  3- Locate “CYDEO” link, verify it is displayed.
        WebElement cydeoLink = driver.findElement(By.xpath("//a[.='CYDEO']"));////a[@href='https://cydeo.com/']
        System.out.println("Before refresh: cydeoLink.isDisplayed(), expecting  true = " + cydeoLink.isDisplayed());
        // 4- Refresh the page.
