...
public class HWP_EtsyTitleVerification {
    public static void main(String[] args) {
      ...
      //  1. Open Chrome browser
       ...
       if (expectedTitle.equals(actualTitle)){
            System.out.println("Title verification has PASSED " + expectedTitle);
        }else {
            System.out.println("Title verification has FAILED "  + expectedTitle);
            System.out.println(actualTitle);
        }
